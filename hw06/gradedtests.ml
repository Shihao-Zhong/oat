...
let ll_opt_file_test path optimize ans =
  ...
  throw_key_diff Llutil.compare_block opt expected
...
let hw4_medium_tests = [
  ...
  ("atprograms/regalloctest2.oat", "", "137999986200000000")  
]
...
let regalloc_challenge_tests = [
 ...
 ("atprograms/run51.oat", "", "341");
 ("atprograms/run52.oat", "", "15");
 ("atprograms/run54.oat", "", "10");
 ("atprograms/run55.oat", "", "6");    
...
let student_submissions =
  [ "hw6programs/aen_greedy_regs.oat", "", "0"
  ; "hw6programs/akashsub_funcargs.oat", "", "0"
  ; "hw6programs/andreasx_coalesce.oat", "", "0"
  ; "hw6programs/askinsj_ifqs.oat", "", "0"
  ; "hw6programs/atter_register_madness.oat", "", "0"
  ; "hw6programs/emsu_test.oat", "", "0"
  ; "hw6programs/geyerj_test_case.oat", "", "0"
  ; "hw6programs/lomay_slow_the_greed.oat", "", "0"
  ; "hw6programs/mattch_bitcasts.oat", "", "0" 
  ; "hw6programs/petrosky_calls.oat", "", "0"
  ; "hw6programs/sakhavan_loop_call.oat", "", "0"
  ; "hw6programs/smumick_battleitout.oat", "", "0"
  ; "hw6programs/wangandr_test.oat", "", "0" (* bad test *)]

let manual_tests : suite = [
  Test ("Posted Piazza Test Case",
        pass_all_executed_oat_file student_submissions)
  ;
